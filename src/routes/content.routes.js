...
const {
    createContentType, updateContentTypeNameById, addFieldToContentType, deleteFieldFromContentType, renameFieldInContentType 
...
router.patch('/:id/field/:fieldId', renameFieldInContentType); // rename a field in a content type
